...
| AI電子商取引コピーライティングアシスタント | プロンプトに基づいて電子商取引のコピーを素早く生成 | リンク | [Link](https://github.com/302ai/302_e_commerce_copywriting_assistant) |
| AIウェブページ要約 | ワンクリックでウェブページの内容を要約 | リンク | [Link](https://github.com/302ai/302_webpage_summary) |
